...
const containerCode = `
<Container>
    <Row className="p-2 bg-body-secondary border border-300">
        <Col>1 of 1</Col>
    </Row>
</Container>
`;
...
<Container>
  <Row className="p-2 mb-2">
    <Col sm={8} className="p-2 bg-body-secondary border border-300">sm=8</Col>
    <Col sm={4} className="p-2 bg-body-secondary border border-300">sm=4</Col>
  </Row>
  <Row className="p-2">
    <Col sm className="p-2 bg-body-secondary border border-300">sm=true</Col>
    <Col sm className="p-2 bg-body-secondary border border-300">sm=true</Col>
    <Col sm className="p-2 bg-body-secondary border border-300">sm=true</Col>
  </Row>
</Container>`;
...
<Container>
    <Row className="p-2 mb-1">
        <Col className="p-2 bg-body-secondary border border-300">
          1 of 3
        </Col>
        <Col className="p-2 bg-body-secondary border border-300">
          2 of 3
    ...
    <Row className="p-2 mb-1">
        <Col xs={3} className="p-2 bg-body-secondary border border-300">
          xs=3
        </Col>
        <Col xs={4} className="p-2 bg-body-secondary border border-300">
          xs=4
        </Col>
        <Col xs={5} className="p-2 bg-body-secondary border border-300">
          xs=5
        </Col>
    </Row>

    <Row className="p-2">
        <Col className="p-2 bg-body-secondary border border-300">1 of 3</Col>
        <Col xs={5} className="p-2 bg-body-secondary border border-300">2 of 3 (wider)</Col>
        <Col className="p-2 bg-body-secondary border border-300">3 of 3</Col>
    </Row>
</Container>
`;
...
<Container>
  ...
  <Row className="p-2 mb-1">
    <Col xs={12} md={8} className="p-2 bg-body-secondary border border-300">
      xs=12 md=8
    </Col>
    <Col xs={6} md={4} className="p-2 bg-body-secondary border border-300">
      xs=6 md=4
    </Col>
  </Row>
  ...
  <Row className="p-2">
    <Col xs={6} className="p-2 bg-body-secondary border border-300">xs=6</Col>
    <Col xs={6} className="p-2 bg-body-secondary border border-300">xs=6</Col>
  </Row>
</Container>
`;
...
<Container>
  <Row className="p-2">
    <Col xs className="p-2 bg-body-secondary border border-300">First, but unordered</Col>
    <Col xs={{ order: 12 }} className="p-2 bg-body-secondary border border-300">Second, but last</Col>
    <Col xs={{ order: 1 }} className="p-2 bg-body-secondary border border-300">Third, but second</Col>
  </Row>
</Container>`;
...
<Container>
  <Row className="p-2">
    <Col md={4} className="p-2 bg-body-secondary border border-300">md=4</Col>
    <Col md={{ span: 4, offset: 4 }} className="p-2 bg-body-secondary border border-300">{"md={{ span: 4, offset: 4 }}"}</Col>
  </Row>
  <Row className="p-2">
    <Col md={{ span: 3, offset: 3 }} className="p-2 bg-body-secondary border border-300">{"md={{ span: 3, offset: 3 }}"}</Col>
    <Col md={{ span: 3, offset: 3 }} className="p-2 bg-body-secondary border border-300">{"md={{ span: 3, offset: 3 }}"}</Col>
  </Row>
  <Row className="p-2">
    <Col md={{ span: 6, offset: 3 }} className="p-2 bg-body-secondary border border-300">{"md={{ span: 6, offset: 3 }}"}</Col>
  </Row>
</Container>`;

const columnWidthInRowCode = `<Container>
  <Row xs={2} md={4} lg={6} className="p-2">
    <Col className="p-2 bg-body-secondary border border-300">1 of 2</Col>
    <Col className="p-2 bg-body-secondary border border-300">2 of 2</Col>
  </Row>
  <Row xs={1} md={2} className="p-2">
    <Col className="p-2 bg-body-secondary border border-300">1 of 3</Col>
    <Col className="p-2 bg-body-secondary border border-300">2 of 3</Col>
    <Col className="p-2 bg-body-secondary border border-300">3 of 3</Col>
  </Row>
...
const widthAutoCode = `
  <Container>
      <Row className="justify-content-md-center p-2">
          <Col xs lg="2" className="p-2 bg-body-secondary border border-300">
            1 of 3
          </Col>
          <Col md="auto" className="p-2 bg-body-secondary border border-300">auto width content</Col>
          <Col xs lg="2" className="p-2 bg-body-secondary border border-300">
            3 of 3
          </Col>
      </Row>
