      ...
      <DocPagesLayout>
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body hidePreview>
            <p className="mb-0">
              ...
              sides with shorthand classes. Includes support for individual properties, all
              properties, and vertical and horizontal properties. Classes are built from a default
              Sass map ranging from .25rem to 3rem.
            </p>
          </PhoenixDocCard.Body>
        </PhoenixDocCard>
        ...
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body>
            ...
            <ul>
              ...
              <li>
                blank - for classes that set a <code>margin</code> or <code>padding</code> on all 4
                sides of the element
              </li>
            </ul>
            <p>
              Where<em> size </em> is one of: <code>0</code>, <code>1</code>, <code>2</code>,{' '}
              <code>3</code>, <code>4</code>, <code>5</code>, <code>6</code>, <code>7</code>,{' '}
              <code>8</code>, <code>9</code>, <code>10</code>, <code>11</code>, <code>12</code>,{' '}
              <code>13</code>, <code>14</code>, <code>15</code> &amp; <code>auto</code>
            </p>
          </PhoenixDocCard.Body>
        </PhoenixDocCard>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Horizontal centering">
            <p className="mb-0 text-800">
              Additionally, Bootstrap also includes an <code>.mx-auto</code> class for horizontally
              centering fixed-width block level content—that is, content that has{' '}
              <code>display: block</code> and <code>a width</code> set—by setting the horizontal
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header noPreview title="Negative margins">
            <p className="mb-0 text-800">
              ...
              <code>padding </code>cannot). These negative margins are <strong>disabled </strong>by
              default, but can be enabled in Sass by setting{' '}
              <code>$enable-negative-margins: true</code>. The syntax is nearly the same as the
              default, positive margin utilities, but with the addition of <code>n </code>before the
              requested size. Here’s an example class that’s the opposite of <code>.mt-1</code>:
            </p>
          </PhoenixDocCard.Header>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Gap">
            <p className="mb-0 text-800">
              When using <code>display: grid</code>, you can make use of <code>gap</code> utilities
              on the parent grid container. This can save on having to add margin utilities to
              individual grid items (children of a <code>display: grid</code> container). Gap
              utilities are responsive by default, and are generated via our utilities API, based on
              the <code>$spacers</code> Sass map.
            </p>
          </PhoenixDocCard.Header>
