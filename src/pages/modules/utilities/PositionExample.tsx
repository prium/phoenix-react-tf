...
const arrangElementsCode = `<>
  <div className="position-relative bg-200 mb-4" style={{ height: '200px' }}>
    <div className="light p-3 bg-body-quaternary rounded-1 position-absolute top-0 start-0"></div>
    <div className="light p-3 bg-body-quaternary rounded-1 position-absolute top-0 end-0"></div>
    <div className="light p-3 bg-body-quaternary rounded-1 position-absolute top-50 start-50"></div>
    <div className="light p-3 bg-body-quaternary rounded-1 position-absolute bottom-50 end-50"></div>
    <div className="light p-3 bg-body-quaternary rounded-1 position-absolute bottom-0 start-0"></div>
    <div className="light p-3 bg-body-quaternary rounded-1 position-absolute bottom-0 end-0"></div>
  </div>
...
const centerElementsCode = `<div className="position-relative bg-200" style={{height: '200px'}}>
  <div className="light p-3 bg-body-quaternary rounded-1 position-absolute top-0 start-50 translate-middle-x"></div>
  <div className="light p-3 bg-body-quaternary rounded-1 position-absolute top-50 start-0 translate-middle-y"></div>
  <div className="light p-3 bg-body-quaternary rounded-1 position-absolute top-50 start-50 translate-middle"></div>
  <div className="light p-3 bg-body-quaternary rounded-1 position-absolute top-50 end-0 translate-middle-y"></div>
  <div className="light p-3 bg-body-quaternary rounded-1 position-absolute bottom-0 start-50 translate-middle-x"></div>
</div>`;
