      ...
      <DocPagesLayout>
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Example">
            <p className="mb-0">
              Use the <code>striped</code>, <code>bordered</code> and <code>hover</code> props to
              customise the table.
            </p>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Dark Table">
            <p className="mb-0">
              Use <code>variant="dark"</code> to invert the colors of the table and get light text
        ...
        <PhoenixDocCard className="mb-5">
          <PhoenixDocCard.Header title="Striped columns">
            <p className="mb-0">
              Use <code>striped="columns"</code> to add zebra-striping to any table column.
            </p>
          </PhoenixDocCard.Header>
        ...
        <PhoenixDocCard className="mb-5">
          <PhoenixDocCard.Header title="Always responsive">
            <p className="mb-0">
              Across every breakpoint, use <code>responsive</code> for horizontally scrolling
              tables. Responsive tables are wrapped automatically in a <code>div</code>. The
