...
const RatingExample = () => {
  return (
    <div className="mb-9">
      <DocPageHeader
        title="Rating"
        description={`React-${process.env.REACT_APP_TITLE} uses React Simple Rating as rating component. It's a simple react component for adding a star rating to your project.`}
        link={{
