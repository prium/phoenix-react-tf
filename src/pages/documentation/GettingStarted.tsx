    ...
    <div>
      <DocPageHeader className="mb-4" title="Getting Started">
        <p className="mb-0">
          ...
          <strong>{process.env.REACT_APP_TITLE}-React</strong> theme is organized, basics of how to
        ...
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body>
            ...
            <ol className="mb-0 ps-3">
              ...
              <li>
                Open the “{process.env.REACT_APP_TITLE}-React” directory with your cmd or terminal
              </li>
              <li>
                Run <code>npm i</code>
                <br />
                This command will download all the necessary dependencies for{' '}
                {process.env.REACT_APP_NAME} in the <code>node_modules</code> directory.
              </li>
              <li>
        ...
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body>
            <p>
              ...
              <code>homapage</code> in your <code>package.json</code> file to change asset files
              relative paths. For more information visit{' '}
              <a
              ...
              Then Run <code>npm run build</code> command in your project directory to make the
              Production build.
            </p>
            <p>
              This will create an optimized production build by compililing, merging and minifying
              all the source files as necessary and will put them in the <code>build/</code> folder.
            </p>
            <p>
