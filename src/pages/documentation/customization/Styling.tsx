      ...
      <DocPagesLayout>
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body className="text-800">
            <p>
              You can add your own SCSS and override the theme style in the <code>user.scss</code>{' '}
              file.
            </p>
            ...
            <p>
              To make broader changes to the design of the theme, such as changing the color scheme
              or font sizes, use <code>src/assets/scss/_user-variables.scss</code>. Any variable
              from <code>node_modules/bootstrap/scss/_variables.scss</code> or{' '}
              <code>src/assets/scss/theme/_variables.scss</code> can be overridden with your own
              value.
            </p>
            ...
            <p>
              To remove bootstrap components, update <code>src/scss/_bootstrap.scss</code> file.
            </p>
            <div className="border rounded-1 bg-white px-3 py-2 mt-4 mb-3">
        ...
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body className="text-800">
            <p>
              ...
              <code> src/scss/_user-variables.scss </code> then update variables as your necessity.
            ...
            <p className="mt-3">
              ...
              <code>$dark-theme-colors</code> variable and to update the grays colors you have to
              update the <code>$dark-grays </code>variable.
            </p>
            ...
            <p>
              To update theme color with this approach, you have to update CSS variable for both
              modes. If you change any color you have to assign its corresponding RGB color too.
              Please note that sometimes you may need to update corresponding component's CSS
        ...
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body>
            <p>
              Run <code>npm run build:css</code> command in your project directory to compile scss.
              This will compile all the SCSS files from <code>src/assets/scss/</code> directory and
              generate <code> theme.min.css </code>,<code> theme-rtl.min.css </code>,{' '}
            ...
            <p>
              <strong>
                You can also use the SCSS watcher to automatically compile and reload your browser
                every time you save your SCSS files by running the command
              </strong>
