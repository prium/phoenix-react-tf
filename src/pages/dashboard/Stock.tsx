...
const Stock = () => {
  return (
    <>
      ...
      <div className="mx-n4 mx-lg-n6 mt-4 px-lg-6 py-5 border-top">
        <TopStocks />
      </div>
      <div className="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis py-5 border-y mb-5 mb-md-8 mb-lg-9">
