  ...
  return (
    <Row className="flex-center mb-15 mt-11 gy-6">
      <Col xs="auto">
        ...
        <img src={illustration30Dark} alt="" className="d-light-none" width={305} />
      </Col>
      <Col xs="auto">
        <div className="text-center text-lg-start">
          <h3 className="text-1000 mb-2">
            <span className="fw-semi-bold">Want to have the</span> ultimate customer experience?
          </h3>
          <h1 className="display-3 fw-semi-bold mb-4">
            Become a <span className="text-primary fw-bolder">member</span> today!
          </h1>
