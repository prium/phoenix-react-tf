...
import fileManager13 from 'assets/img/file-manager/12.png';
    ...
    <Card className="mt-5">
      ...
      <Card.Body className="pt-0">
        <div className="myfiles-action-bar mx-n4 mb-4">
          ...
          {/* -------- */}
          <div id="file-manager-actions" className="d-none">
          ...
          <Button
            variant="phoenix-secondary"
            className={classNames('fs-10 btn-square-sm', {
              'd-none d-xxl-block': true
            })}
          ...
          <Button
            ...
            data-phoenix-target="#fileDetailsOffcanvas"
          >
            <FontAwesomeIcon icon={faInfoCircle} />
          </Button>
        </div>
