...
const RoomCard = () => {
  ...
  return (
    <div>
      {roomsSearchData.map((data, index) => (
        <Card
          key={index}
          className={index !== roomsSearchData.length - 1 ? 'mb-3' : ''}
        >
          <Card.Body>
            <Row className="gx-4 justify-content-between">
              ...
              >
                <div>
                  <h6 className="mb-3 fw-bolder text-body-tertiary text-uppercase">
                    <span className="d-none d-sm-inline-block">No. of</span>
                    Beds
                  </h6>
              ...
              <Col xs={12}>
                <Collapse in={open}>
                  <div id={`collapseRoomAvailableOnDates${index}`}>
                            ...
                            <div
                              className={classNames(
                                'text-center pe-4 pe-md-5 pe-xl-7',
                                {
                                  'border-end':
                                    dateIndex !==
                                    data.availableOnDates.length - 1
                                }
                              )}
                            >
