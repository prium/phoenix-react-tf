...
const WidgetTables = () => {
  ...
  return (
    <div>
      ...
      <div className="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis py-5 border-y border-300">
        <ProjectDashboard />
      </div>
      ...
      <div className="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis pt-7 mt-3 border-y border-300">
