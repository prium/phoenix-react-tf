    ...
    <div className="position-relative py-15">
      <div>
        <div
          ...
          style={{ transform: 'skew(0,-8deg)', backgroundImage: `url(${bg13})` }}
        />
        <div
            ...
            <Row className="row mb-6">
              ...
              <div className="col-xl-6 text-center text-md-start">
                <p className="text-white">
                  You can get all the reports, data analysis, and growth maps you need with the help
                  of Phoenix's power, and you may review and modify them whenever you want. These
